...
function AccordionTrigger({
  ...
  return (
      <AccordionPrimitive.Header className="flex">
        ...
        >
          {children}
          <PlusCircle className="fill-blue-500 text-white group-data-[state=open]:hidden" size="40"/>
          <MinusCircle className="fill-blue-500 text-white group-data-[state=closed]:hidden" size="40"/>
        </AccordionPrimitive.Trigger>
