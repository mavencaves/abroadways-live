...
const categories = [
    {
        ...
        items: [
            { rank: "১৭৪", description: "সেরা বিশ্ব র‍্যাঙ্কিং স্কুলসমূহে – ২০২৩" },
        ],
    },
    {
        id: "qs_rank",
        ...
        icon: <Star className="w-6 h-6 text-[#6246ea]" />,
        items: [
            { rank: "১৩৭", description: "সেরা বিশ্ব র‍্যাঙ্কিং স্কুলসমূহে – ২০২০" },
        ],
    },
    {
    ...
    },
    {
        ...
        icon: <Star className="w-6 h-6 text-[#6246ea]" />,
        items: [
            { rank: "৬", description: "সেরা বিশ্ব র‍্যাঙ্কিং স্কুলসমূহে – ২০২৫" },
        ],
    },
]

const highlights = [
    {title: "প্রতিষ্ঠিত", text: "১৮৭৮"},
    {title: "মোট শিক্ষার্থীর সংখ্যা", text: "৬৬৭৬৮"},
...
export default function UniversityOfMontreal() {
    return (
        <UniversityLayout
            backgroundUrl="/images/montreal.jpg"
            name="মন্ট্রিয়াল বিশ্ববিদ্যালয়"
            location="মন্ট্রিয়াল, কানাডা"
            logo="/images/icons/montreal.png"
        >
            <div className={"mx-auto flex flex-col gap-10"}>
                ...
                <TopCoursesSection
                    courses={courses}
                    mscCourseName="মাস্টার অফ ল'স ইন কম্পারেটিভ কমন ল'"
                    mscDuration="২৪ মাস"
                />
                <IntakeSection
                    intakes={intakes}
