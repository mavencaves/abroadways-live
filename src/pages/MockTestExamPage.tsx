        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-6 py-16 lg:grid-cols-[1.3fr_0.7fr] lg:items-end">
          ...
          <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-1">
            {[
              ...
              ["Monetization", "Free previews + premium packs"],
            ].map(([label, value]) => (
        ...
        {isLoading ? (
          ...
          <div className="grid gap-10 lg:grid-cols-[0.78fr_1.22fr]">
            <aside className="space-y-6">
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                <h2 className="text-xl font-semibold text-slate-900">Commercial model</h2>
                <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-600">
                  <li>Free sets help students preview the product.</li>
                  <li>Premium packs unlock paid practice libraries.</li>
                  <li>Full result explanations, recommendations, and answer review stay behind paid access.</li>
                </ul>
              </div>
            </aside>
              ...
              <div className="flex items-end justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-600">
                    Free and premium sets are published from the same mock-test engine, with paid packs unlocked from the student portal.
                  </p>
                </div>
              </div>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          <div className="flex flex-wrap gap-2">
                            ...
                            >
                              {set.accessType === "paid" ? "Premium pack" : "Free set"}
                            </span>
                          </div>
                          <h3 className="mt-3 text-xl font-semibold text-slate-900">{set.title}</h3>
                          <p className="mt-2 text-sm leading-6 text-slate-600">
                        ...
                        <div className="space-y-2 text-right">
                          ...
                          {set.accessType === "paid" ? (
                            <p className="text-xs font-semibold text-amber-700">
                              {(set.price || 0).toLocaleString("en-BD")} {set.currency || "BDT"}
                            </p>
                          ) : null}
                        </div>
                      </div>
