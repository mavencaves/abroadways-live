...
const publicPageSchema = new mongoose.Schema(
  {
    ...
    siteLogo: { type: String, trim: true, default: "" },
    siteLogoAlt: { type: String, trim: true, default: "" },
    siteLogoDark: { type: String, trim: true, default: "" },
    siteLogoDarkAlt: { type: String, trim: true, default: "" },
